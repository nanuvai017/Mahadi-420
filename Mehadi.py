...
\033[31;1m 888b     d888          888                    888 d8b      
 \033[30;1m8888b   d8888          888                    888 Y8P      
\033[35;1m 88888b.d88888          888                    888          
\033[33;1m888Y88888P888  .d88b.  88888b.   8888b.   .d88888 888      
\033[30;1m888 Y888P 888 d8P  Y8b 888 "88b     "88b d88" 888 888      
\033[33;1m888  Y8P  888 88888888 888  888 .d888888 888  888 888      
\033[30;1m888   "   888 Y8b.     888  888 888  888 Y88b 888 888      
\033[30;1m888       888  "Y8888  888  888 "Y888888  "Y88888 888           King                                                                                                                                                                                                             
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} Md Mehadi Sarkar               {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Md Mehadi         {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801606777866          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}https://github.com/nanuvai017{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
   {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
   {H} ║{P}[{H}•{P}] Version   : {H}2.0.9                 ║
   {H} ║{P}[{H}•{P}] Tools     : {H} Mehadi GREEN             ║
   {M} ╚════════════════════════════════════════╝ {P}""")
